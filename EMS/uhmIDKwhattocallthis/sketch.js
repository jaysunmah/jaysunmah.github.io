var sketch = function (p) {
    ...
    function Planet(star, distance, speed) {
        ...
        var starPos = this.star.getPos();
        var gFactor = -this.star.getMass() / Math.pow(distance, 3);
    ...
    Planet.prototype.update = function (dt) {
        ...
        var gFactor = -this.star.getMass() / Math.pow(this.relPos.mag(), 3);
